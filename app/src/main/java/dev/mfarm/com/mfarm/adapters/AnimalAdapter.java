...
public class AnimalAdapter extends ArrayAdapter<animal> implements Filterable {
	...
	private List<animal> supplierList;
	private List<animal> origsupplierList;

	public AnimalAdapter(Context ctx, List<animal> supplierList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		animal sup = supplierList.get(position);
		holder.planetNameView.setText(sup.getName());
